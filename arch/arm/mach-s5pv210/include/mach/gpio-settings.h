...
#if defined(CONFIG_SAMSUNG_FASCINATE) || defined(CONFIG_MACH_VENTURI)
...
#endif
#if defined(CONFIG_MACH_VENTURI)
	{S5PV210_GPG3(2), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE},
#else
...
#else //CONFIG_SAMSUNG_VIBRANT CONFIG_SAMSUNG_GALAXYS CONFIG_SAMSUNG_FASCINATE CONFIG_MACH_VENTURI
...
static unsigned int sleep_gpio_table[][3] =
{
...
#if defined(CONFIG_MACH_VENTURI)
	{S5PV210_GPB(7),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_GPB7 (NC)
#else
	{S5PV210_GPB(7),  S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_GPB7 (CAM_IO_EN)
#endif

	// GPC0 -------------------------------------------------
#if defined(CONFIG_ARIES_NTT) || defined(CONFIG_MACH_VENTURI)
	...
	{S5PV210_GPD1(3), S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE},	//GPIO_HDMA_SCL_28V
...
#if defined(CONFIG_MACH_VENTURI)
	{S5PV210_GPF3(4), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_GPF34
#else
...
#elif defined(CONFIG_MACH_VENTURI)
	{S5PV210_GPJ1(4), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_J14_NC
#else
...
#if defined(CONFIG_MACH_VENTURI)
	{S5PV210_GPJ4(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//NC
#else
...
#if defined(CONFIG_MACH_VENTURI)
	{S5PV210_MP01(4), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_NC
#else
...
#endif
#if defined(CONFIG_MACH_VENTURI)
	{S5PV210_MP03(3), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_NC
#else
...
#if defined(CONFIG_MACH_VENTURI)
	{S5PV210_MP04(2), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_LCD_SCLK
#else
...
static unsigned int sleep_alive_gpio_table[][4] =
{
...
#if defined(CONFIG_MACH_VENTURI)
	{S5PV210_GPH1(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_GPH13
#endif
#if defined (CONFIG_SAMSUNG_FASCINATE)
...
#if defined(CONFIG_ARIES_NTT) || defined(CONFIG_SAMSUNG_FASCINATE) || defined(CONFIG_MACH_VENTURI)
	...
	{S5PV210_GPH2(1), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_GPH21
...
#elif defined(CONFIG_MACH_VENTURI)
	{S5PV210_GPH3(5), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_35_NC
	{S5PV210_GPH3(7), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_37_NC
#else //CONFIG_SAMSUNG_VIBRANT CONFIG_SAMSUNG_GALAXYS
	{S5PV210_GPH3(7), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE,  S3C_GPIO_PULL_NONE}, //GPIO_CP_RST
#endif
};
